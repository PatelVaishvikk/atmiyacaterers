    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-gray-100 py-12 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          <div className="bg-gray-900 rounded-3xl p-4 shadow-2xl w-full max-w-md mx-auto lg:sticky lg:top-8">
            <div className="bg-black rounded-2xl p-2">
              <div className="bg-white rounded-xl overflow-hidden">
                ...
                {/* Input Area - render only after mount to avoid hydration mismatch from extensions */}
                {mounted && (
                  <div className="bg-gray-50 p-3 flex items-center gap-2">
                    <div className="text-gray-500 hover:text-gray-700 cursor-pointer">
                      ...
                      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 16 16">
                        ...
                        <path d="M2 2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2z"/>
                      </svg>
                    </div>
                    <div className="text-gray-500 hover:text-gray-700 cursor-pointer">
                      {/* simple doc icon */}
                      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 16 16">
                        <path d="M4 0h5l4 4v10a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2zM9 1.5V4h2.5L9 1.5z"/>
                      </svg>
                    </div>
                    ...
                    <div className="text-gray-500 hover:text-gray-700 cursor-pointer">
                      {/* 3 dots icon (safe replacement for the corrupted grid) */}
                      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <div className="bg-green-500 p-2 rounded-full cursor-pointer hover:bg-green-600 transition-colors">
                      {/* simple send triangle (safe replacement for corrupted send path) */}
          ...
          <div className={`bg-white rounded-2xl p-6 shadow-lg w-full max-w-md transition-opacity duration-500 ${isTransitioning ? 'opacity-0' : 'opacity-100'}`}>
            <div className="text-center">
              <div className="flex justify-center mb-4">{getAvatar(currentReview.name)}</div>
              ...
              <div className="bg-green-50 rounded-xl p-4 mb-4">
                <div className="text-lg font-semibold text-green-800 mb-1">{currentReview.orderType}</div>
        ...
        <div className="mt-16 bg-white rounded-2xl p-8 shadow-xl">
          <h3 className="text-2xl font-bold text-center text-gray-900 mb-6">Real Customer Screenshots 📸</h3>
